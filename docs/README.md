...
- A copyable template lives in [`../.env.example`](../.env.example).
...
- [SETUP.md](./SETUP.md)
- [DEPLOY_AUTOMATION.md](./DEPLOY_AUTOMATION.md)
- [LOCAL_SETUP.md](./LOCAL_SETUP.md)
- [SETUP_BACKEND.md](./SETUP_BACKEND.md)
- [FEATURES.md](./FEATURES.md)
- [ARCHITECTURE.md](./ARCHITECTURE.md)
- [BAN_APPEAL_SYSTEM.md](./BAN_APPEAL_SYSTEM.md)
- [CODEBASE_FAMILIARIZATION_AUDIT.md](./CODEBASE_FAMILIARIZATION_AUDIT.md)
