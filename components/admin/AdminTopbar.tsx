...
export function AdminTopbar({ title, subtitle, unreadNotifications, onRefresh, refreshing, onOpenSidebar }: AdminTopbarProps) {
  return (
    <header className="sticky top-0 z-20 border-b bg-white/95 px-4 py-4 backdrop-blur lg:px-8">
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative rounded-lg border p-2 text-gray-600" aria-label="Notifications">
